...
public class GEOMS_CO {
    ...
    public void beforeClass() throws IOException {
        ...
        //Chrome Browser
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\USER\\Downloads\\chromedriver-win64 (4)\\chromedriver-win64\\chromedriver" + ".exe");
...
//        }
        ...
        testlogin.tf_emailAdd.sendKeys(dataset.EMAIL_CO_AU);
        testlogin.tf_pw.sendKeys(dataset.PW_CO_AU);
...
//        test_frame.btn_success_modal_ok.click();
        ...
        softAssert.assertTrue(test_frame.txt_Search.isDisplayed());
        test_frame.txt_Search.sendKeys(dataset.SQAD);
        test_frame.txt_Search.sendKeys(Keys.ENTER);
        ...
        softAssert.assertTrue(test_frame.btn_update_submit.isDisplayed());
        test_frame.btn_update_submit.click();

        eWait.until(ExpectedConditions.visibilityOf(test_frame.btn_update_success_modal_ok));
...
//        test_frame.btn_update_success_modal_ok.click();
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);",   test_frame.btn_close_modal);
...
//        softAssert.assertTrue(certification.dd_Survey.isDisplayed());
    ...
    public void account() throws InterruptedException {
        ...
        F_role.selectByVisibleText("CO - AU");
